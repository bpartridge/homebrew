...
class Yaafe < Formula
  head 'https://github.com/yomguy/yaafe.git'
  ...
  def install
    ...
    system "mkdir", "-p", "#{prefix}/lib/#{python.xy}/site-packages"
    system "cp", "-r", "#{prefix}/python_packages/yaafelib", "#{prefix}/lib/#{python.xy}/site-packages/"
    system "cp", "-r", "#{prefix}/yaafe_extensions/yaafefeatures.py", "#{prefix}/lib/#{python.xy}/site-packages/"
  end
